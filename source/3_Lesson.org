...
:HTML_CONTAINER_CLASS: learn
:END:
- In this lesson you will learn about functions, loops and variables.
...
- You will need use the comments feature, your teacher will show you how, to explain the concepts of Functions, Loops and Variables.
- You will have only _one_ lesson to work on this, so don't make it too complicated.

- For the *silver* badge - you will define the three terms.
- For the *gold* badge - you tag the correct Scratch block for each term.
- For the *platinium* badge - you need to explain why the three concepts are useful to the programmer. 
