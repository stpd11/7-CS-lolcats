...
:HTML_CONTAINER_CLASS: learn
:END:
- In this second lesson of this topic we are going to learn to create basic scripts to follow a sequence.
...
- *Gold:* You complete the death and reset scripts.
- *Platinum*: You add a new script that when you click the button =b= it changes the background.
